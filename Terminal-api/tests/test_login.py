...
class LoginTest(unittest.TestCase):
    ...
    def test_post(self, mock_class):
        ...
        status_code, response = post(query_url, info)
        ...
        status_code, response = logout_post(query_url_out, info_out)
    ...
    def test_response_not_200(self, mock_class):
        ...
        with self.assertRaises(SystemExit) as cm:
            logout_post(query_url_out, info_out)
        self.assertEqual(cm.exception.code, 0)
    ...
    def test_server_inspect(self, mock_class):
        ...
        self.assertEqual(mock_class.call_args, mock.call(query_url, info))
        output = "usr_name"
    ...
    def test_logout(self, mock_class):
        ...
        self.assertEqual(mock_class.call_args, mock.call(query_url_out, info_out))
